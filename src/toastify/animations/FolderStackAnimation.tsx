...
export function FolderStackAnimation({
  ...
  const offset = collapsed ? index * 10 : index * 66;
  ...
  return (
    <motion.article
      ...
      aria-atomic="true"
      initial={{ opacity: 0, x: 0, y: isTop ? targetY - 14 : targetY + 14, scale: 0.94 }}
      animate={{
      ...
      exit={{ opacity: 0, x: exitX, scale: 0.94, transition: { duration: 0.24, ease: [0.16, 1, 0.3, 1] } }}
