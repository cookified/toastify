      ...
      <div className="my-auto w-full max-w-[640px] text-center space-y-6 py-12">
        ...
        >
          <div className="group/copy relative">
            <div
              className={`pointer-events-none absolute -inset-0.5 rounded-lg bg-gradient-to-r from-emerald-500/30 to-amber-500/30 blur-xs transition-opacity duration-300 ${
                copied ? "opacity-100" : "opacity-0 group-hover/copy:opacity-40"
              }`}
            />
